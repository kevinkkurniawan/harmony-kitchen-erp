    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden select-none relative">
      ...
      {viewMode === 'list' && (
        <div className="flex-1 overflow-hidden flex flex-col p-4 gap-4">
          ...
          {/* Main Table Grid of Priced Receipts */}
                ...
                {isLoadingList ? (
                  ...
                  receiptsList.map((row) => (
                    <tr key={row.id} className={isDark ? 'hover:bg-slate-800/50' : 'hover:bg-slate-50'}>
                      ...
                      <td className="py-3.5 px-4 font-mono font-bold text-slate-300">{row.poNo || '-'}</td>
                      <td className="py-3.5 px-4 font-bold">{row.paymentType} ({row.dueDate || '-'})</td>
